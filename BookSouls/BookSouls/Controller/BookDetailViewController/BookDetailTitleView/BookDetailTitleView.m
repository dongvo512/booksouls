...
- (void)setDataForView:(Book *)book{
    ...
    [Common hightLightLabel:self.lblAuthor withSubstring:book.author withColor:[UIColor colorWithHexString:@"#252C3A"] font:[UIFont fontWithName:@"Muli-SemiBoldItalic" size:14.0]];
